...
// Phase 1: buildScenePrompt and buildTransformPrompt moved here from background-generator.ts
...
export function buildTransformPrompt(artStyle: string, cardText?: string): string {
