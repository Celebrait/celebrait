...
const V2_CELEBRAIT_REGISTER = `THE LOOK — start every card from the Celebrait register: GRAPHIC and BOLD, one confident ground colour, type doing real work, objects not scenes, current not antique. The register is a SPECTRUM you may use all of: from pure flat print to gently dimensional 3D-FLAT — paper-cut depth, soft shadows, rounded sculptural forms, tactile materials — as long as it stays graphic and deliberate. Photorealism is never home.
