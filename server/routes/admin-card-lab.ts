...
- format: one of "statement", "hero", "pattern", "label", "typeled". THE SET MUST SPAN THE RANGE, one card each: EXACTLY ONE "typeled" (text-only), ONE of "statement" (minimal, one motif and lots of air) or "hero" (one object huge), and ONE of "pattern" or "label" (dense). Pair each with whichever angle flatters it — any angle may take the typeled card.
