...
⚠️ THE SUBJECT CHOOSES THE COLOUR, NOT A HOUSE HABIT. Reach for whatever volume THIS thing actually asks for, and weigh the two answers equally: saturated or quiet, bright or dark, hot or neutral. ⚠️ Neither is the safe one — a rack where every card shouts and a rack where none of them do are the same failure. Let the subject decide it, never a habit and never this instruction.
