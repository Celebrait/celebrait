...
7. PICTURE — the words and the described artwork must complete each other. If the line would work over ANY picture, it FAILS.
8. CLEAN CRAFT — parses as a natural sentence, correctly spelled, max one exclamation mark, no "vibes/level up/boss/legend/goals/mode".
