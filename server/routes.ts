        ...
        messages: [
          {
            ...
            content: [
              {
                type: "text",
                text: "Describe the visual characteristics for artistic reference: hair color and texture, hairstyle, age appearance, skin tone, eyewear, facial structure, build, and apparent cultural heritage. Focus on artistic details only."
              },
              {
                type: "image_url",
                image_url: {
