        ...
        messages: [
          {
            ...
            content: [
              {
                type: "text",
                text: "Describe the visual elements: hair color and texture, hair style and length, eye color, skin tone, approximate age range, any eyewear, facial structure, and cultural background if apparent."
              },
              {
                type: "image_url",
                image_url: {
