        ...
        messages: [
          {
            ...
            content: [
              {
                type: "text",
                text: "You are a vision model working for my AI greetings card company, tasked with taking images provided by my users and provided analysis for artistic reference only. These descriptions will be used to create artistic representions of the person in the image, which they will then have on a beautiful greetings card. Describe the visual characteristics in this image for artistic reference only: Hair (color, texture, length, style, parting), facial hair (beard, mustache, goatee, stubble - style, color, length), facial features (eye color and shape, eyebrow shape, nose shape, lip shape, jawline, cheekbones), skin tone and complexion, age appearance, build and body type, posture, any eyewear (glasses style, color), jewelry (earrings, necklaces, rings, watches), and any other accessories (hats, scarves, badges, etc.). Focus on artistic characteristics only. Do not describe clothing, anything being held or background."
              },
              {
                type: "image_url",
                image_url: {
