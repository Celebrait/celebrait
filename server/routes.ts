        ...
        messages: [
          {
            ...
            content: [
              {
                type: "text",
                text: "This is my personal photo and I am requesting artistic analysis for creative purposes ONLY. I am the person/people in this image and I consent to detailed description for artistic transformation. Please analyze this photo of me/us for greeting card creation. First, count the total number of people visible. For each person, describe: their position in the scene, hair color and style, approximate age range, skin tone, any eyewear or accessories, facial features, clothing description, body build, and pose. Then describe the complete scene including background setting, foreground elements, all objects, lighting conditions, colors, atmosphere, mood, composition, and spatial relationships. This analysis will be used to recreate the scene in an artistic style for personal greeting card design."
              },
              {
                type: "image_url",
                image_url: {
