...
export async function registerRoutes(app: Express): Promise<Server> {
  ...
  app.post("/api/transform-style", async (req, res) => {
    try {
      ...
      // Create style transformation prompt
      const stylePrompts = {
        anime: "Transform this image into anime style with vibrant colors, expressive features, and characteristic anime art elements",
        watercolor: "Transform this image into a soft watercolor painting with flowing colors and gentle brush strokes",
        oil_painting: "Transform this image into a classical oil painting with rich textures, depth, and traditional painting techniques",
        digital_art: "Transform this image into modern digital art with clean lines and contemporary illustration style",
        cartoon: "Transform this image into a stylized cartoon illustration with bold colors and simplified forms",
        realistic: "Transform this image into a highly detailed photorealistic rendering with enhanced clarity and detail",
        sketch: "Transform this image into a hand-drawn pencil sketch with crosshatching and artistic shading",
        impressionist: "Transform this image into an impressionist painting with loose brushstrokes and light effects",
        pop_art: "Transform this image into bold pop art style with bright colors and graphic elements",
        minimalist: "Transform this image into a clean minimalist design with simple forms and limited color palette",
        vintage: "Transform this image into vintage style with retro aesthetics and nostalgic elements",
        cyberpunk: "Transform this image into cyberpunk style with neon elements, futuristic aesthetics, and sci-fi atmosphere"
      };
