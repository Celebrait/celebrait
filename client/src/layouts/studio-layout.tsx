    ...
    <nav className="flex-1 py-4 overflow-y-auto">
      ...
      <div className="px-3 mb-4">
        <Link
          ...
          onClick={onNavigate}
          className="flex items-center justify-center gap-2 w-full hero-cta bg-cta hover:bg-cta-hover text-white rounded-full py-2.5 text-sm font-semibold transition-colors shadow-sm"
