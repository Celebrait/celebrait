...
const TEST_PROMPTS = [
  {
    ...
    frontPrompt: "Watercolor artwork covering entire square canvas edge to edge, Sarah an adult english_sa woman with blonde wavy hair, slim build, blue eyes, cheerful personality, standing in sunflower field at golden hour in yellow sundress, watercolor style, text \"Happy Birthday Sarah\" prominently displayed across image, artwork fills complete frame with no white space or borders",
    frontPromptNoText: "Watercolor artwork covering entire square canvas edge to edge, Sarah an adult english_sa woman with blonde wavy hair, slim build, blue eyes, cheerful personality, standing in sunflower field at golden hour in yellow sundress, watercolor style, artwork fills complete frame with no white space or borders",
  ...
  },
  {
    ...
    frontPrompt: "Cartoon artwork covering entire square canvas edge to edge, Mike an adult afrikaner man with brown short neat hair, athletic build, beard, caring personality, sitting by campfire under stars in casual outdoor clothes, cartoon style, text \"Happy Father's Day\" prominently displayed across image, artwork fills complete frame with no white space or borders",
    frontPromptNoText: "Cartoon artwork covering entire square canvas edge to edge, Mike an adult afrikaner man with brown short neat hair, athletic build, beard, caring personality, sitting by campfire under stars in casual outdoor clothes, cartoon style, artwork fills complete frame with no white space or borders",
  ...
  },
  {
    ...
    frontPrompt: "Oil painting artwork covering entire square canvas edge to edge, Emma a teen indian_sa girl with black curly hair, curvy build, dimples, romantic personality, walking on beach at sunset in flowing dress, oil painting style, text \"Be My Valentine\" prominently displayed across image, artwork fills complete frame with no white space or borders",
    frontPromptNoText: "Oil painting artwork covering entire square canvas edge to edge, Emma a teen indian_sa girl with black curly hair, curvy build, dimples, romantic personality, walking on beach at sunset in flowing dress, oil painting style, artwork fills complete frame with no white space or borders",
  ...
  },
  {
    ...
    frontPrompt: "Realistic artwork covering entire square canvas edge to edge, Alex a young_adult coloured_sa man with brown fade hair, slim build, glasses, ambitious personality, standing in front of university buildings in graduation cap and gown, realistic style, text \"Congratulations Graduate\" prominently displayed across image, artwork fills complete frame with no white space or borders",
    frontPromptNoText: "Realistic artwork covering entire square canvas edge to edge, Alex a young_adult coloured_sa man with brown fade hair, slim build, glasses, ambitious personality, standing in front of university buildings in graduation cap and gown, realistic style, artwork fills complete frame with no white space or borders",
  ...
  const generateCard = async (preset: any, customPromptText?: string) => {
    try {
      ...
      const insidePrompt = cardType === 'front-and-inside' ? 
        `${preset?.artStyle || 'elegant'} style artwork covering entire square canvas edge to edge, elegant background with subtle decorative elements, text "${preset?.insideMessage || 'Hope your special day brings you joy and happiness!'}" prominently displayed in beautiful readable typography, artwork fills complete frame with no white space or borders, interior greeting card design` : 
        null;
