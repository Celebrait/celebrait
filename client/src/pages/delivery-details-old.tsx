...
export default function DeliveryDetails() {
  ...
  // Debug logging
  console.log('[DELIVERY DETAILS] Preselected delivery type:', preselectedDeliveryType);
  console.log('[DELIVERY DETAILS] Selected delivery type:', selectedDeliveryType);
  ...
  const handleProceedToRecipient = () => {
    if (selectedDeliveryType) {
      // Navigate to recipient selection with the selected delivery type
      setLocation(`/delivery-details/${reference}?type=${selectedDeliveryType}&step=recipient`);
    }
  };
