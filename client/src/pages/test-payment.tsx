...
export default function TestPayment() {
  ...
  return (
    <div className="mobile-safe bg-gradient-to-br from-purple-50 to-blue-50 py-6 sm:py-8 lg:py-12">
      <div className="container-wide">
        <div className="text-center mb-6 sm:mb-8 lg:mb-12">
          <h1 className="mb-2 sm:mb-4">Paystack Payment System Test</h1>
            ...
            <CardContent className="space-y-3 sm:space-y-4">
              ...
              <div className="space-y-3">
                <Button
                  ...
                  className="btn-responsive w-full touch-target"
                  variant="outline"
                >
