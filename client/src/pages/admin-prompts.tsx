...
const CELEBRAIT_HOUSE_STYLE =
  'Modern animated illustration style — the look and feel of a premium animated film like Pixar, DreamWorks, or Studio Ghibli. The character should be a stylised but recognisable version of themselves with natural proportions (NOT chibi, NOT children\'s cartoon, NOT caricature). Render with smooth, polished digital shading — soft cel-shading with gentle shadow transitions, warm ambient light, and subtle highlights on hair and eyes. Skin should be smooth and clean but with realistic warmth and colour variation (NOT flat plastic, NOT photographic pores). Eyes should be expressive with visible highlights but NOT oversized or anime-proportioned. The overall feel should be "premium animated character portrait" — the person looks like themselves but elevated, like they\'ve been drawn by a top-tier animation studio artist. Colour palette: warm golden-hour tones — sunset oranges, ambers, soft teals, dusty pinks. Environment rendered in the same warm animated style with atmospheric depth and soft lighting. Think: if this person had a cameo in a Pixar film, this is how they\'d look.';
