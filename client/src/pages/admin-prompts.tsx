...
const CELEBRAIT_HOUSE_STYLE =
  'Warm, polished animated illustration — the quality of a premium animated film but depicting ADULTS, not teenagers or children. Character rendering: smooth poreless skin with warm undertones and a soft blush on cheeks and nose. ONE clean shadow tone under the chin and jawline — no gradient shading, no photographic lighting. Hair rendered as chunky, defined, flowing strands with golden-amber highlights — NOT fine individual hairs. Nose simplified to a smooth shape with a single highlight — no detailed nostrils. Teeth simplified as clean white shapes when smiling. Eyes expressive with clear highlights but ADULT-PROPORTIONED — not oversized, not cute, not anime, not Disney-princess-young. The character must look their ACTUAL AGE from the reference photo — maintain mature facial proportions, jawline definition, and adult body proportions. Do NOT make the character look younger, cuter, or more childlike than the reference. Freckles and skin details rendered as artistic dots, not photographic texture. Clothing has visible patterns but rendered as flat painted shapes with a single shadow tone, not fabric texture. Background: painterly brushstroke quality in sky and clouds, warm atmospheric haze, simplified foliage and environmental shapes. Sand and ground rendered with artistic texture, not photographic grain. Overall colour palette: warm golden-hour — sunset oranges, ambers, warm teals, dusty pinks, honey-gold lighting throughout. The complete image should look like a high-quality animated character portrait of a real adult — warm, charming, polished, stylised but emotionally authentic.';
