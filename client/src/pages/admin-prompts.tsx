...
const CELEBRAIT_HOUSE_STYLE =
  'ANIMATED ILLUSTRATION STYLE — this is NOT a photograph, NOT photorealistic, NOT a digital painting with realistic lighting. This is a HAND-DRAWN ANIMATED CHARACTER in the style of a modern animated film. Render the character as a stylised animated version of themselves: expressive features with slightly larger eyes that have visible highlights and reflections, a warm genuine smile, smooth simplified skin with soft cel-shading (distinct shadow shapes, NOT smooth gradients). Proportions are gently exaggerated — slightly larger head, expressive hands, appealing animated proportions like a Pixar or Studio Ghibli character. Outlines should be clean and confident with subtle line weight variation. ZERO photographic texture — no pores, no photo-realistic skin, no camera-like depth of field. Instead use flat colour areas with warm cel-shaded shadows and highlights. Colour palette: warm sunset oranges, golden ambers, soft teals, dusty pinks — everything bathed in golden-hour warmth. Environment rendered in the same animated style: simplified shapes, warm atmospheric lighting, soft bokeh suggested through artistic blur not camera blur. The overall impression should look like a frame from a premium animated film — warm, charming, polished, and unmistakably illustrated, not photographed.';
