    ...
    <>
      ...
      >
        ...
        <button
          ...
          className="relative w-full aspect-video rounded-2xl bg-gradient-to-br from-brand-muted via-white to-keeper-gold-wash border border-keeper-hair overflow-hidden flex items-center justify-center hover:shadow-lg transition-all"
