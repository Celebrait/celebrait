...
export function FabNewCard() {
  return (
    <Link
      ...
      className="fixed bottom-6 right-6 z-40 sm:hidden flex items-center gap-2 pl-4 pr-5 h-14 rounded-full bg-cta hover:bg-cta-hover text-cta-foreground shadow-lg shadow-cta/30 hover:shadow-xl transition-all hover:scale-[1.02] active:scale-[0.98]"
