...
export default function GuidedConversation({ onboarding, onCardGenerated }: GuidedConversationProps) {
  ...
  const steps: ConversationStep[] = [
    ...
    },
    {
      ...
      aiMessage: `Perfect! Now I can create ${answers.name || 'their'} greeting cards in 2 ways (plural). Choose the option that works best for you (click the "How it Works" button for examples and best practices):`,
