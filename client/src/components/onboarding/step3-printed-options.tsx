  ...
  return (
    <div className="bg-white/60 backdrop-blur-sm rounded-3xl p-4 sm:p-6 lg:p-8 shadow-xl border border-white/20 max-w-4xl mx-auto">
      <div className="text-center mb-6 sm:mb-8">
        <h2 className="text-2xl sm:text-3xl lg:text-4xl font-bold text-gray-800 mb-3 sm:mb-4">Perfect choice! 🎨</h2>
        <p className="text-base sm:text-lg text-slate-gray px-4">Now, what part of your card would you like us to design?</p>
      </div>
          ...
          <CardContent className="p-4 sm:p-6">
            ...
            <div className="relative w-full aspect-square rounded-xl mb-4 overflow-hidden bg-gray-100">
              ...
              <button
                ...
                className="absolute left-2 top-1/2 transform -translate-y-1/2 bg-black/50 hover:bg-black/70 text-white rounded-full p-1.5 sm:p-2 transition-all duration-200 z-10"
              >
              ...
              <button
                ...
                className="absolute right-2 top-1/2 transform -translate-y-1/2 bg-black/50 hover:bg-black/70 text-white rounded-full p-1.5 sm:p-2 transition-all duration-200 z-10"
              >
                <ChevronRight className="w-3 h-3 sm:w-4 sm:h-4" />
              </button>
              
              {/* Slide Indicator and Label */}
              <div className="absolute bottom-2 left-1/2 transform -translate-x-1/2 bg-black/70 text-white px-2 sm:px-3 py-1 rounded-full text-xs sm:text-sm font-medium">
            ...
            <ul className="space-y-2 sm:space-y-3 mb-4 sm:mb-6">
              <li className="flex items-start text-slate-gray text-sm sm:text-base">
                ...
                <span>AI-designed front and inside</span>
              </li>
              <li className="flex items-start text-slate-gray text-sm sm:text-base">
                <Check className="text-green-500 mr-2 sm:mr-3 w-4 h-4 mt-0.5 flex-shrink-0" />
                <span>Complete personalized message</span>
              </li>
              <li className="flex items-start text-slate-gray text-sm sm:text-base">
                <Check className="text-green-500 mr-2 sm:mr-3 w-4 h-4 mt-0.5 flex-shrink-0" />
                <span>Direct delivery ready</span>
              </li>
              <li className="flex items-start text-slate-gray text-sm sm:text-base">
                <Check className="text-green-500 mr-2 sm:mr-3 w-4 h-4 mt-0.5 flex-shrink-0" />
                <span>Coordinated design theme</span>
              </li>
            </ul>
            
            <div className="flex items-center justify-between mb-4">
              <span className="text-xl sm:text-2xl font-bold text-warm-pink">R129</span>
              <span className="text-xs sm:text-sm text-green-600 font-medium">Complete package!</span>
            </div>
            
            <div className="p-3 sm:p-4 bg-purple-50 rounded-lg">
              <div className="flex items-start space-x-2">
                <Gift className="text-purple-600 w-4 h-4 mt-0.5 flex-shrink-0" />
        ...
        >
          <CardContent className="p-4 sm:p-6">
            ...
            <ul className="space-y-2 sm:space-y-3 mb-4 sm:mb-6">
              <li className="flex items-start text-slate-gray text-sm sm:text-base">
                <Check className="text-green-500 mr-2 sm:mr-3 w-4 h-4 mt-0.5 flex-shrink-0" />
                <span>AI-designed front cover</span>
              </li>
              <li className="flex items-start text-slate-gray text-sm sm:text-base">
                <Check className="text-green-500 mr-2 sm:mr-3 w-4 h-4 mt-0.5 flex-shrink-0" />
                <span>Write your own message inside</span>
              </li>
              <li className="flex items-start text-slate-gray text-sm sm:text-base">
                <Check className="text-green-500 mr-2 sm:mr-3 w-4 h-4 mt-0.5 flex-shrink-0" />
                <span>Perfect for personal touch</span>
              </li>
              <li className="flex items-start text-slate-gray text-sm sm:text-base">
                <Check className="text-green-500 mr-2 sm:mr-3 w-4 h-4 mt-0.5 flex-shrink-0" />
                <span>Blank interior for handwriting</span>
              </li>
            </ul>
            
            <div className="flex items-center justify-between mb-4">
              <span className="text-xl sm:text-2xl font-bold text-ethereal-purple">R89</span>
              <span className="text-xs sm:text-sm text-slate-gray font-medium">Standard</span>
            </div>
            
            <div className="p-3 sm:p-4 bg-blue-50 rounded-lg">
              <div className="flex items-start space-x-2">
                <Lightbulb className="text-blue-600 w-4 h-4 mt-0.5 flex-shrink-0" />
